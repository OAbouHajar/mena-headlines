...
const translations = {
  en: {
    ...
    priceChartTitle: '7-Day Price History',
    priceChartError: 'Price history unavailable',
    ...
    marketBriefUp: '↑ Higher',
    marketBriefDown: '↓ Lower',
    marketBriefSideways: '→ Sideways',
    marketBriefHigh: 'High conviction',
    ...
    // AI Challenge / Predictions
    predBtn: 'AI Challenge',
    predPanelTitle: 'AI Challenge',
    predBadge: 'Question of the Day',
    predPollTitle: 'Question of the Day',
    predYes: 'Yes',
    predNo: 'No',
    predAiPicked: 'AI picks',
    predNoActive: 'No active question right now.',
    predExpired: 'Expired',
    predExpiresHours: (h) => `Expires in ${h}h`,
    predExpiresDays: (d) => `Expires in ${d}d`,
    predSeeAnalysis: 'Full Analysis →',
    predShare: 'Share',
    predShareTitle: 'AI Challenge',
    predShareText: (q, pick) => `${q}\n\nAI picks: ${pick}\n\nmena-headlines.com`,
    predShareCopied: 'Copied!',
    predVotesTotal: 'votes',
  },
  ar: {
    appTitle: 'Middle East Live',
    ...
    priceChartTitle: 'تاريخ الأسعار (7 أيام)',
    priceChartError: 'تاريخ الأسعار غير متاح',
    ...
    marketBriefUp: '↑ ارتفاع',
    marketBriefDown: '↓ انخفاض',
    marketBriefSideways: '→ مستقر',
    marketBriefHigh: 'ثقة عالية',
    ...
    // AI Challenge / Predictions
    predBtn: 'تحدّي AI',
    predPanelTitle: 'تحدي الذكاء الاصطناعي',
    predBadge: 'سؤال اليوم',
    predPollTitle: 'سؤال اليوم',
    predYes: 'نعم',
    predNo: 'لا',
    predAiPicked: 'توقّع AI',
    predNoActive: 'لا يوجد سؤال نشط الآن.',
    predExpired: 'انتهت المدة',
    predExpiresHours: (h) => `ينتهي خلال ${h} ساعة`,
    predExpiresDays: (d) => `ينتهي خلال ${d} يوم`,
    predSeeAnalysis: 'التحليل الكامل →',
    predShare: 'مشاركة',
    predShareTitle: 'تحدّي AI',
    predShareText: (q, pick) => `${q}\n\nتوقّع AI: ${pick}\n\nmena-headlines.com`,
    predShareCopied: 'تم النسخ!',
    predVotesTotal: 'تصويت',
  },
};
