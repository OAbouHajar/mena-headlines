...
const translations = {
  en: {
    ...
    statsAlertGreen: 'Info',
    statsAlertOrange: 'Watch',
    statsAlertRed: 'Alert',
    statsAcledNote: 'Conflict data requires ACLED API key',
    // Tension card
    tensionTitle: 'Global Tension Index',
    tensionLow: 'Low',
    tensionModerate: 'Moderate',
    tensionElevated: 'Elevated',
    tensionCritical: 'Critical',
    tensionNote: 'Derived from active GDACS disaster alerts. Indicative only.',
  },
  ar: {
